...
if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['upload_product_submit'])){
    ...
    if(!empty($_FILES['product_img']['name'])){
        ...
        if($productImg_fileError === 0){
            ...
            if($productImg_fileSize < 10000000){
                ...
                header("location: ../normal/addMovies.php?msg=ImgSizeTooLarge");
            }



        }else{
            header("location: ../normal/addMovies.php?msg=ImgErrorOccured");
        }



    }else{
        header("location: ../normal/addMovies.php?msg=notSupportedImg");
    }
        ...
        header("location: ../normal/addMovies.php?msg=uploadImg");
    }
    ...
    if(empty($product_title) || empty($product_amount) || empty($commission) || empty($level) ){
        header("location: ../normal/addMovies.php?msg=fillAllFields");
    }
    else{
    ...
    header("location: ../normal/movies.php?msg=success");
    ...
    if(empty($product_title) || empty($product_amount) || empty($commission) || empty($level) ){
        ...
        header("location: ../normal/movies.php?msg=success&page=update&id=$id");
