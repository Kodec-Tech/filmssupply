                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="light">
                                                                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
                                                                                <input type="hidden" name="close_id" value="<?php echo $row['Account_No']; ?>">
                                                                                <button name="close_btn" type="submit" class="btn btn-danger"><i class="bx bx-error"></i> Close</button>
                                                                            </form>
                                                                        </td>
                                                                        <!-- <td class="light">
