...
<?php
//Lets fetch user level
//catching the hidden account number
$acctNo = '';
$level = '';
...
//fetch from DB
$levelsql = "SELECT level FROM mymembership WHERE acctNo = '$acctNo';" ;
    $levelresult = mysqli_query($conn, $levelsql);
        ...
        //checking for errors
        $levelresultcheck = mysqli_num_rows($levelresult);

        if($levelresultcheck > 0){
...
//To determine user commission through level
//initialize 
$commission = [];
if($level == 'normal'){
    $commission = 0.7;
...
if(isset($_GET['page'])){
    ...
    $id = isset($_GET['id']);
    $sql = "SELECT * FROM merge_product WHERE id = '$numb';" ;
                ...
                <div class="container-fluid px-2  px-lg-5  px-md-0">
                    ...
                    <div class="container-fluid px-0  pt-2 px-lg-4 dark_bg light ">
                        ...
                        <div class="col col-md-10 col-lg-8 col-xl- px-0  mx-auto py-4 my-5">
                            <div class="col mb-5">
                                <h2>Grand Order Editor </h2>
                                <p class="text-white">Here you can easily add grand order for this user.
                                </p>
                            </div>



                            <form action="../includes/addMergeMovie.inc.php" method="POST" enctype="multipart/form-data">

                            <input type="hidden" value="<?php echo $numb ?>" name="numb">

                            <input type="hidden" name="username" value="<?= $username ?>">

                            <input type="hidden" name="account_number" value="<?= $acctNo ?>">
                                ...
                                <div class="col my-3">
                                    ...
                                    ?>" 
                                            id="max_value" style="border:2px solid #616161 !important; border-radius:7px !important" >

                                        </div>

                                        <div class="col px-0 mt-2 pr-md-2">
                                            <label for="max_value">Grand Order Unit:</label>

                                            <input class="form-control bg-transparent text-white" type="number" 
                                            name="grand_order_unit" 
                                            value="" 
                                            required
                                            id="max_value" style="border:2px solid #616161 !important; border-radius:7px !important" >
                                ...
                                <div class="col my-3">
                                    ...
                                    <div class="d-block d-md-flex align-items-center  gx-md-2 mb-3 bg-transparent text-white">
                                        <div class="col px-0 mt-2 pr-md-2">
                                            ...
                                            <label for="min_value">User Level:</label>

                                            
                                        <input type="text" class="form-control bg-transparent text-white" name="level" value="<?php if(isset($_GET['id'])){
                                    ...
                                    <input type="file" 
                                        class="form-control   bg-transparent  " style=" height:max-content; border:2px solid #616161 !important; border-radius:7px
...
if (isset($_GET['msg'])) {
    ...
    if ($msg === 'notSupportedImg') {
        echo "
        <script>
            Swal.fire({
                icon: 'error',
                title: 'Not supported!',
                text: 'Not supported image file type! exp: png, jpeg, jpg, jfif',
