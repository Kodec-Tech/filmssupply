    ...
    <div class="simplebar-content" style="padding: 0px;">
        ...
        <ul class="navbar-nav align-self-stretch">
            ...
            <li class="">
                ...
                <a class="nav-link text-left active" role="button" href="Dashboard.php" aria-haspopup="true" aria-expanded="false">
            ...
            <li class="menuHover">
                        <a href="../admin/wallet/mwithdraw.php" class="nav-link text-left" role="button">
                        ...
                        <div class="container-fluid ">
                            <div class="row">
                                <div class="col-lg-12 px-2">
                                    <div class="submenu-box">
                                        <ul class="list-unstyled m-0">
                                            <li><a href="../admin/normal/movies.php">Normal </a></li>
                                            <li><a href="../admin/vip/movies.php">VIP </a></li>

                                            <li><a href="../admin/vvip/movies.php">VVIP</a></li>

                                            <li><a href="../admin/vvvip/movies.php">VVVIP</a></li>

                                            <li><a href="../admin/gold/movies.php">Gold</a></li>
                                            <li><a href="../admin/diamond/movies.php">Diamond </a></li>
            ...
            <li class="menuHover">
                        <a href="../admin/upgrade/user.php" class="nav-link text-left" role="button">
                                ...
                                <div class="col-lg-12 px-2">
                                    <div class="submenu-box">
                                        <ul class="list-unstyled m-0">
                                            ...
                                            <!-- <li><a href="../admin/accounts/KycValidation.php">Kyc Verification Requests</a></li> -->
            ...
            <li class="menuHover">
                <a href="../admin/setting.php" class="nav-link text-left" role="button">
