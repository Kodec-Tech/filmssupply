<nav class="fixed-top align-top" id="sidebar-wrapper" role="navigation">
            <div class="simplebar-content" style="padding: 0px;">
                ...
                <ul class="navbar-nav align-self-stretch">
                    ...
                    <li class="">
                        ...
                        <a class="nav-link text-left " role="button"  href="../Dashboard.php"  aria-haspopup="true" aria-expanded="false">
            ...
            <li class="menuHover">
                        <a href="../upgrade/user.php" class="nav-link text-left active" role="button">
