                         ...
                         <div class="col">
                            ...
                            <div class="col">
                                <div class="row align-items-center justify-content-between ">
                                    <div class="col">
                                        <h2 class="fs-3">Upgrade User Accounts</h2>
                                ...
                                <div class="table-responsive">
                                    ...
                                    >
                                        <thead>
                                            <tr class="text-center">
                                                ...
                                                <th class="border-top-0 bg-secondary text-white py-3 px-4">Account No</th>
                                                <th class="border-top-0 bg-secondary text-white py-3 px-4 text-center">
                                                    Username</th>
                                                <th class="border-top-0 bg-secondary text-white py-3 px-4">Membership</th>
                                                <th class="border-top-0 bg-secondary text-white py-3 px-4">Date Created
                                                </th>
                                    ...
                                    <?php
                                    $count=1;
                                    $sql = "SELECT * FROM mymembership ORDER BY `level_id` DESC";
                                    ...
                                    if ($result) { ?> <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                <button style="color: blue; background-color: #124; border: 1px solid blue">

                                                    <a
                                                    href="mymembership.php?page=update&id=<?php echo $rows['level_id']?>"
                                                        >Update</a>
                                                    </button>
                                    ...
                                    >
                                        <div class="col">
                                            ...
                                            <p
                                                class="mt-5"
                                                style="color:#616161"
                                            >This space is empty, enjoy the silence or upload an
                                                investment </p>
                                        </div>
                                    </div>
