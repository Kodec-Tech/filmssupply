...
if(isset($_GET['page'])){
    ...
    $id = isset($_GET['id']);
    $sql = "SELECT * FROM mymembership WHERE level_id= '$numb';" ;
            ...
            <div id="content">
                ...
                <div class="container-fluid px-2  px-lg-5  px-md-0">
                    ...
                    <div class="container-fluid px-0  pt-2 px-lg-4 dark_bg light ">
                        ...
                        <div class="col col-md-10 col-lg-8 col-xl- px-0  mx-auto py-4 my-5">
                            <div class="col mb-5">
                                ...
                                <p class="text-dark">Here you can easily upgrade this user membership level.
                                </p>
                            </div>



                            <form action="../includes/updateMembership.inc.php" method="POST">
                            <input type="hidden" value="<?php echo $numb ?>" name="numb">
                                <div class="col my-3">
                                    ...
                                    ?>" name="username" id="title" readonly>
                                </div>
                                ...
                                <div class="col my-3">
                                    ...
                                    <div class="d-block d-md-flex align-items-center  gx-md-2 mb-3 bg-transparent text-white">
                                        <div class="col px-0 mt-2 pr-md-2">
                                            ...
                                            <label for="min_value">User Account Number</label>

                                            <input class="form-control bg-transparent text-white" type="number" name="acctNo" value="<?php if(isset($_GET['id'])){
                                        echo $acctNo;
                                    } 
                                    ?>"  style="border:2px solid #616161 !important; border-radius:7px !important" readonly>
                                        </div>

                                        <div class="col px-0 mt-2 pr-md-2">
                                            <label for="max_value">Date Created</label>

                                            <input class="form-control bg-transparent text-white" type="text" name="dateCreated" value="<?php if(isset($_GET['id'])){
                                        echo $dateCreated;
                                    } 
                                    ?>" id="max_value" style="border:2px solid #616161 !important; border-radius:7px !important" readonly>
                                ...
                                <div class="col my-3">
                                    <label>User Membership Level</label>

                                    <div class=" bg-transparent text-white d-flex align-items-center " style=" height:max-content;  border-radius:7px
                                                !important">
                                                
                            <?php if(isset($_GET['id'])){
                                        echo '<select class="form-control  mb-3  bg-transparent  " style=" height:max-content; border:2px solid #616161 !important; border-radius:7px
                                        !important" aria-label=".form-select-lg example" name="membership">
                            ...
                            ?>
                                        <select class="form-control  mb-3  bg-transparent  " style=" height:max-content; border:2px solid #616161 !important; border-radius:7px
                                                !important" aria-label=".form-select-lg example" name="status">
                  ...
                  <?php if(isset($_GET['id'])){
                    ...
                    echo '<input type="submit" id="submit" class="btn text-white py-3 bg-success w-100  mt-5" value="Update User Membership" name="user_membership_submit">';
                  }
                  else{
                  ?>

                
                         <input type="submit" id="submit" class="btn text-white py-3 bg-primary w-100  mt-5" value="Update user membership" name="crypto-submit" disabled>
