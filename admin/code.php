...
if (isset($_POST['VerifyAc'])) {
    ...
    //Now checking for the user other details:
    ...
    if (mysqli_num_rows($result) > 0) {
        while ($row = mysqli_fetch_assoc($result)) {
          ...
          //Assigning the variables to session 
          $_SESSION['accountnumber'] = $AccountNo;
        ...
        //   verifyUserMail($_SESSION['accountnumber'], $_SESSION['firstname'], $_SESSION['email'], $_SESSION['accountname']);
