...
$(document).ready(function () {
    ...
    $('#PanNo').blur(function () {
        ...
        if (PanNo == "" || PanNo.length > 10 || PanNo.length < 10) {
            ...
            $('#PanError').text('Invalid Phone Number');
            $("#nextBtn").attr('disabled', true);
            PanError = 1;
        }
        else {
            ...
            if (!regex.test(PanNo)) {
                ...
                $('#PanError').text('Invalid Phone Number Format');
                $("#nextBtn").attr('disabled', true);
                PanError = 1;
            }
            else {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response != "0") {
                            $("#PanError").text("Phone Number Already Exist");
                            $("#nextBtn").attr('disabled', true);
                            PanError = 1;
                        }
                        else {
    ...
    $("#FirstName").blur(function () {
        ...
        if (Fname == "") {
            ...
            if (!Expression.test(Fname)) {
                $("#FnameError").text("Name doesn't contain Numbers or Symbol");
                $("#nextBtn").attr('disabled', true);
                FnameError = 1;
            }
            else {
    ...
    $("#Username").change(function () {
        ...
        if (!Username == "") {
            ...
            if (!regex.test(Username)) {
                $("#UsernameError").text("Please Enter Valid Username containing letters and number");
