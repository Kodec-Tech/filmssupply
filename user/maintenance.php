...
<head>
    ...
    <style>
        body {
            ...
            background-image: url('https://www.transparenttextures.com/patterns/black-paper.png'); /* Use a texture image */
        ...
        .container::after {
            ...
            width: 30px;
            height: 30px;
            background: url('https://www.pngall.com/wp-content/uploads/5/Push-Pin-PNG-Pic.png') no-repeat center center / contain; /* Use pin icon image */
            position: absolute;
            top: -15px;
...
<body>
    ...
    <g id="small">
      ...
      <animateTransform attributeName="transform" begin="0s" dur="2s" from="0 78 21" repeatCount="indefinite" to="-360 78 21" type="rotate"/>
        ...
        <p>We're currently performing scheduled maintenance. We should be back online shortly.</p>
