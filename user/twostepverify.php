            ...
            <div class="col-md-6 offset-md-6" style="background: white; padding: 20px; margin-top: 40px;">
                ...
                <form action="check.php" method="post">
                    <div style="text-align: center;">
                        ...
                        <button type="submit" name="verifyBtn" class="btn btn-md btn-primary" style="width: 160px;border-radius: 40px;">Skip</button>
                        <button type="submit" name="verifySkip" class="btn btn-md btn-info" style="width: 160px;border-radius: 40px;">Verify</button>
                </form>
