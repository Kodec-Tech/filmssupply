    ...
    $("#Pay").click(function () {
        ...
        if (AccountNo != "") {
            ...
            if (Amount >0) {
                $("#AmountError").text("");
                swal({
                    title: "Are you sure you want to make  Transfer of Amount" + "   " + "$" + Amount,
                    icon: "warning",
                    buttons: true,
                    dangerMode: true,
                }).then((willDelete) => {
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                ...
                                if (Status == "Active") {
                                    ...
                                    $("#AcError").text("Invalid account number. Kindly check again");
                                }
                            }
                        });
                ...
                $("#AmountError").text("Please Enter Minimum 100 USD");
            }
        }
        else {
