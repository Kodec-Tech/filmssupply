...
<head>
  ...
  <style>
    .notification {
      ...
      /* Added padding-right to give more space for the close button */
      color: white;
      border-radius: 5px;
      z-index: 1000;
      font-size: 14px;
    ...
    .close-btn {
      ...
      right: 10px;
      /* Adjust this value to position it further from the edge */
      font-size: 24px;
      /* Adjusted font size */
      cursor: pointer;
      ...
      margin-left: 10px;
      /* Adjust spacing to the left of the button */
    }
  </style>
</head>
...
<body class="tasks_body">
  ...
  <main class="zoom_tasks">
    ...
    mysqli_stmt_bind_param($stmt, "ssi", $level, $reset, $products_list);
