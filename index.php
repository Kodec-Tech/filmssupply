...
<body class="container">
  ...
  <section class="hero">
    <h1 class="hero__title">
      Testing Filmssupply from Dev Environment
    </h1>
  ...
  <section id="services" class="features section__padding">
    ...
    <div class="features__cards">
      <div class="features__cards--card-1 features__card">
        ...
        <a
          href="#"
          class="features__cards--card-1__link features__card--link section__sub-link"><span>Learn More <i class="fa-solid fa-angle-right"></i></span></a>
      </div>
      ...
      <div class="features__cards--card-2 features__card">
        ...
        <a
          href="#"
          class="features__cards--card-2__link features__card--link section__sub-link"><span>Learn More <i class="fa-solid fa-angle-right"></i></span></a>
      </div>
      ...
      <div class="features__cards--card-3 features__card">
        ...
        <a
          href="#"
          class="features__cards--card-3__link features__card--link section__sub-link"><span>Learn More <i class="fa-solid fa-angle-right"></i></span></a>
      </div>
    </div>
  ...
  <section id="about" class="about section__padding">
    <div class="about__pt-1 about__pt">
      <div class="about__pt-1--content about__pt--content">
        ...
        <a
          ...
          class="about__pt-1--content__link about__pt--content__link">Join Us</a>
      </div>
    ...
    <div class="about__pt-2 about__pt">
      ...
      <div class="about__pt-2--content about__pt--content">
        ...
        <a
          href="user/CreateAccount.php"
          class="about__pt-2--content__link about__pt--content__link">Join Us</a>
      </div>
    </div>
    ...
    <div class="about__pt-3 about__pt">
      <div class="about__pt-3--content about__pt--content">
        ...
        <a
          href="user/CreateAccount.php"
          class="about__pt-3--content__link about__pt--content__link">Join Us</a>
      </div>
