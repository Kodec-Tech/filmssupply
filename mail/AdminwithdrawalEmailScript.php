...
function sendWithdrawalApprovalEmail( $message, $customerMail, $name, $amount, $accountNumber, $status,  $walletName="" )
 {
    ...
    $content = file_get_contents(__DIR__ . '/AdminWithdrawalTemp.php');
